...
NA values are removed. The first eight columns that acted as identifiers for the experiment were also removed.
...
The model produced a very small OOB error rate of .56%. So we can keep going on.
